      ...
      <Container fluid className={`pe-5 ps-5 ${styles.footer}`}>
        <Row>
          <Col md={12} lg={6}>
            ...
            <div>
              <input
                ...
                className={`${styles.email_input} pe-2`}
              />
              <Button
                variant="secondary"
          ...
          <Col md={12} lg={6}>
            ...
            <div>
              <p className={styles.newsletter_title}>CURRENCY</p>
              <p className="text-white">USD</p>
              <p className={`text-white ${styles.transactions}`}>
        ...
        <Row>
          <Col md={6} lg={4}>
            <h3 className={`text-white ${styles.footer_link_head}`}>
              mettā muse
            </h3>
            <p className="text-white">About Us</p>
            <p className="text-white">Artisans</p>
            <p className="text-white">Boutiques</p>
            <p className="text-white">Contact Us</p>
            <p className="text-white">EU Compliances Docs</p>
          </Col>
          <Col md={6} lg={4}>
            <h3 className={`text-white ${styles.footer_link_head}`}>
              Quick Links
            </h3>
            <p className="text-white">Orders & Shipping</p>
            <p className="text-white">Join/Login as a Seller</p>
            <p className="text-white">Payment & Pricing</p>
            <p className="text-white">Return & Refunds</p>
